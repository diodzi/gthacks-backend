...
const rooms = new Map();
export async function getRooms(c) {
...
export async function getRoom(c) {
...
export async function deleteRoom(c) {
...
const over = new Map();
const under = new Map();
async function broadcast(roomId, message) {
    let parsedMessage;
    try {
